...
&#x20;  Execute no ambiente PostgreSQL (vias pgAdmin ou CLI):

&#x20;  ```sql

&#x20;  CREATE DATABASE gestao\_gado;
...
&#x20;  Crie o arquivo `.env` na raiz do projeto conforme o modelo:
